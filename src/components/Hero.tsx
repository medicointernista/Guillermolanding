        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2 opacity-0 animate-spring" style={{ animationDelay: '0.7s' }}>
              <a
                href="#widget"
                className="inline-flex items-center justify-center gap-2.5 bg-[#25D366] text-white no-underline px-7 py-4 rounded-full text-[15px] font-extrabold tracking-wide uppercase transition-all shadow-[0_4px_24px_rgba(37,211,102,0.4)] hover:bg-[#1ebe57] hover:-translate-y-0.5 hover:shadow-[0_6px_32px_rgba(37,211,102,0.5)] self-start"
              >
