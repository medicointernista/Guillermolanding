export default function Hero() {
  return (
    ...
    >
      ...
      <div className="absolute -bottom-24 -left-16 w-96 h-96 rounded-full bg-[rgba(255,255,255,0.04)] pointer-events-none animate-rotate-glow" style={{ animationDelay: '-4s' }}></div>
      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-14 items-center relative z-10">
        <div>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-2 opacity-0 animate-spring" style={{ animationDelay: '0.7s' }}>
              <a
                href="https://api.whatsapp.com/send/?phone=573244081281&text=Hola%2C+gracias+por+escribirnos+desde+nuestro+anuncio+en+Google.+El+Dr.+Guillermo+Rodr%C3%ADguez+y+su+equipo+est%C3%A1n+para+ayudarte%2C+%C2%BFen+qu%C3%A9+podemos+colaborarte+hoy%3F&type=phone_number&app_absent=0"
                target="_blank"
                rel="noopener"
            ...
            <div className="flex flex-wrap gap-2.5 opacity-0 animate-fade-up" style={{ animationDelay: '0.9s' }}>
              <span className="inline-flex items-center gap-1.5 bg-white/10 border border-white/[0.18] text-white/90 px-3.5 py-1.5 rounded-full text-[13px] font-medium opacity-0 animate-scale-pop transition-all duration-300 hover:bg-white/20 hover:border-white/30 cursor-default" style={{ animationDelay: '1s' }}>
                Sin largas esperas de EPS
              </span>
              <span className="inline-flex items-center gap-1.5 bg-white/10 border border-white/[0.18] text-white/90 px-3.5 py-1.5 rounded-full text-[13px] font-medium opacity-0 animate-scale-pop transition-all duration-300 hover:bg-white/20 hover:border-white/30 cursor-default" style={{ animationDelay: '1.05s' }}>
                Valoración personalizada
              </span>
              <span className="inline-flex items-center gap-1.5 bg-white/10 border border-white/[0.18] text-white/90 px-3.5 py-1.5 rounded-full text-[13px] font-medium opacity-0 animate-scale-pop transition-all duration-300 hover:bg-white/20 hover:border-white/30 cursor-default" style={{ animationDelay: '1.1s' }}>
        ...
        <div className="bg-white/[0.08] border border-white/15 rounded-2xl sm:rounded-3xl backdrop-blur-lg overflow-hidden relative h-full opacity-0 animate-slide-right transition-all duration-300 hover:border-white/30 hover:bg-white/[0.12] group" style={{ animationDelay: '0.4s' }}>
          <div className="w-full h-64 sm:h-80 md:h-96 overflow-hidden relative group-hover:shadow-inner">
            <img
